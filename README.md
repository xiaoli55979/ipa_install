...
基于 GitHub Pages 的自助 iOS / Android 分发页。上传走 **GitHub Releases**，绕开 Git 的 100MB 文件限制，单文件可达 2GB。
...
4. **Attach binaries** 区域拖入 `.ipa` 和/或 `.apk`
...
3. 按**包名**（`CFBundleIdentifier` / `package`）归组
